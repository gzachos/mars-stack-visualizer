...
public abstract class TokenMarker {
	 ...
	 * token. This default definition returns null; override it in
	 ...
	 * or "token prefix". Will match instruction prefixes, e.g. "s" matches
	 * "sw". This default definition returns null; override it in
	 * language-specific subclasses.
	 * 
	 * @param line
	 *            String containing current line
	 * @param tokenList
	 *            first Token on the current line
	 * @param token
	 *            the pertinent Token object
	 * @param tokenText
	 *            the source String that matched to the token
