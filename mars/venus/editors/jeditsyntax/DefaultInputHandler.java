...
public class DefaultInputHandler extends InputHandler {
	...
	public void keyTyped(KeyEvent evt) {
		...
		// if(c != KeyEvent.CHAR_UNDEFINED && (modifiers & KeyEvent.ALT_MASK) ==
		// 0)
		// So let's give it a try!
		// (...later) Bummer, it results in keystroke echoed into editing area
		// when I use Alt
		// combination for shortcut menu access (e.g. Alt+f to open the File
		// menu).
		//
