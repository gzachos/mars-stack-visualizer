...
public class TextAreaDefaults {
	...
	public static TextAreaDefaults getDefaults() {
		...
		DEFAULTS.electricScroll = 0;// was 3. Will begin scrolling when cursor
									// is this many lines from the edge.

		DEFAULTS.cols = 80;
		DEFAULTS.rows = 25;
		DEFAULTS.styles = SyntaxUtilities.getCurrentSyntaxStyles(); // was
		...
		DEFAULTS.bracketHighlight = false; // assembly language doesn't need
											// this.
