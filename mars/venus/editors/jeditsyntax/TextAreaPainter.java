...
public class TextAreaPainter extends JComponent implements TabExpander {
	 ...
	 * returns false.
	 *
	 * NOTE: as of Java 1.4 this method is deprecated and no longer has the
	 * desired effect because the focus subsystem does not call it. I've
	...
	/**
	 * Set the tab size in characters. DPS 12-May-2010. Originally it was fixed
	 * at PlainDocument property value (8).
	 * 
	 * @param size
	...
	public String getToolTipText(MouseEvent evt) {
		...
		// return "Instruction: "+
		// ((InstructionMouseEvent)evt).getLine().toString();
		// }
		// else {
	...
	public void paint(Graphics gfx) {
		...
		// Added 4/6/10 DPS to set antialiasing for text rendering - smoother
		// letters
	...
	protected void paintLine(Graphics gfx, TokenMarker tokenMarker, int line, int x) {// System.out.println("paintLine
																						// "+
																						// (++count));
	...
	protected void paintSyntaxLine(Graphics gfx, TokenMarker tokenMarker, int line, Font defaultFont,
			Color defaultColor, int x, int y) {// System.out.println("paintSyntaxLine
												// line "+ line);
	...
	protected void paintHighlight(Graphics gfx, int line, int y) {// System.out.println("paintHighlight
																	// "+
																	// (++count));
	...
	protected void paintLineHighlight(Graphics gfx, int line, int y) {// System.out.println("paintLineHighlight
																		// "+
																		// (++count));
		int height = fm.getHeight();
