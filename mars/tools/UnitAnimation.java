...
class UnitAnimation extends JPanel implements ActionListener {
	...
	// set the initial state of the variables that controls the animation, and
	// start the timer that triggers the animation.
	...
	// set and execute the information about the current position of each line
	// of information in the animation,
	// verifies the previous status of the animation and increment the position
	// of each line that interconnect the unit function.
