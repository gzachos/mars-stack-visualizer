...
/*
 * Add these two lines in exceptions.java file public static final int
 * EXTERNAL_INTERRUPT_TIMER = 0x00000100; //Add for digital Lab Sim public
 * static final int EXTERNAL_INTERRUPT_HEXA_KEYBOARD = 0x00000200;// Add for
 * digital Lab Sim
 */
...
public class DigitalLabSim extends AbstractMarsToolAndApplication {
	...
	public static final int EXTERNAL_INTERRUPT_TIMER = 0x00000100; // Add for
																	// digital
																	// Lab Sim
	public static final int EXTERNAL_INTERRUPT_HEXA_KEYBOARD = 0x00000200;// Add
																			// for
																			// digital
																			// Lab
																			// Sim
	...
	public class HexaKeyboard extends JPanel {
		...
		public class EcouteurClick implements MouseListener {
			...
			public void mouseClicked(MouseEvent arg0) {
				int i;
				if (KeyBoardValueButtonClick != -1) {// Button already pressed
														// -> now realease
					KeyBoardValueButtonClick = -1;
					updateMMIOControlAndData(OUT_ADRESS_HEXA_KEYBOARD, 0);
					for (i = 0; i < 16; i++)
